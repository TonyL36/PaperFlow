...
| 06 | [统一访问策略](./06-access-policy.md) | 统一访问分类入口，消除鉴权与限流规则漂移 |
...
6. 如果你想理解最近这轮网关重构，再看 [06-access-policy.md](./06-access-policy.md)
   - 这篇专门解释为什么把访问分类从多个过滤器里抽出来，以及现在 JWT 和限流是如何共用同一份决策的
